...
import { FaArrowDown, FaRocket, FaStar } from "react-icons/fa";
...
const Login = () => {
  ...
  > <div className="mb-8 text-center"> <div className="mb-4 flex justify-center"> <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-600 text-white shadow-lg"> <FaStar size={24} />
  </div> </div>
    ...
    <div className="mb-3 flex flex-col items-center text-center">
      ...
      <FaArrowDown className="mt-2 animate-bounce text-blue-600" size={24} />
    </div>
    ...
    <button
      ...
      disabled={loading}
      className="w-full rounded-xl bg-blue-600 p-3 text-lg font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-blue-700 hover:shadow-xl disabled:cursor-not-allowed disabled:bg-gray-400"
    >
      {loading ? "Logging in..." : "Explore Demo"}
    </button>
    ...
    <button
      type="submit"
      disabled={loading}
      className="w-full rounded-xl border border-slate-300 p-3 font-semibold text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed"
    >
